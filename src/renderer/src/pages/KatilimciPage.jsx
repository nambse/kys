...
export default function KatilimciPage() {
  ...
  const handleSaveEdit = (rowIndex) => {
    ...
    window.electron.ipcRenderer.send('update-katilimci-row', { projectId: projectInfo.id, updatedRow });
  ...
  const staticHeaders = [
    { label: "SIRA NO", key: "siraNo" },
    { label: "AD SOYAD", key: "adSoyad" },
    { label: "BAŞVURU NO", key: "basvuruNo" },
    { label: "ASİL YEDEK", key: "asilYedek" },
    { label: "BAŞVURU KATEGORİSİ", key: "basvuruKategorisi" },
    { label: "TC KİMLİK NO", key: "tc" },
    { label: "İL", key: "il" },
    { label: "İLÇE", key: "ilce" },
  ...
  })), [editingRowIndex, editValues, dataReady]);
  ...
  const fields = [
    ...
    },
    {
      ...
      key: "adSoyad",
      fieldType: { type: "input" },
      validations: [{ rule: "required", errorMessage: "Ad Soyad is required" }]
    },
    {
      label: "Başvuru No",
      key: "basvuruNo",
      fieldType: { type: "input" },
      validations: [{ rule: "required", errorMessage: "Başvuru No is required" }]
    },
    {
      label: "Asil Yedek",
      key: "asilYedek",
      fieldType: { type: "input" },
      validations: [{ rule: "required", errorMessage: "Asil/Yedek is required" }]
    },
    {
      label: "Başvuru Kategorisi",
      key: "basvuruKategorisi",
      fieldType: { type: "input" },
      validations: [{ rule: "required", errorMessage: "Başvuru kategorisi is required" }]
    },
    {
      label: "TC Kimlik No",
      key: "tc",
      fieldType: { type: "input" },
      validations: [{ rule: "required", errorMessage: "TC is required" }]
    },
    {
      label: "İl",
      key: "il",
      fieldType: { type: "input" },
      validations: [{ rule: "required", errorMessage: "İl is required" }]
    },
    {
      label: "İlçe",
      key: "ilce",
      fieldType: { type: "input" },
      validations: [{ rule: "required", errorMessage: "İlçe is required" }]
    },
    {
      label: "Mahalle",
      key: "mahalle",
      fieldType: { type: "input" },
      validations: [{ rule: "required", errorMessage: "Mahalle is required" }]
    },
    {
      label: "HUID",
      key: "huid",
      fieldType: { type: "input" },
      validations: [{ rule: "required", errorMessage: "HUID is required" }]
    }
  ];

...
function SidebarNav({ checkIfDbSelected = true, isItRafflePage = false }) {
  ...
  return (
    <Fragment>
    <div className="fixed bottom-0 left-0 flex flex-col items-start z-10 p-4 space-y-2">
      ...
      <button
        onClick={toggleMenu}
        className={`h-10 w-10 border-none bg-gray-700 text-white p-2 rounded-full hover:bg-gray-800 focus:outline-none mt-2 transition duration-300 shadow-md`}
      >
